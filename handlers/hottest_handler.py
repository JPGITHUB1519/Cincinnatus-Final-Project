...
class HottestPost(Handler):
	def get(self):
		post_numdata_comments =  Comment.numdata_comments_all_post()
		dic_hottest_posts = Blog.hottest_posts(post_numdata_comments, 5)
		# ordering
		...
		hottest_category = Comment.numcomments_all_category()
